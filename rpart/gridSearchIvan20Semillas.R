...
PARAM$semillas <- c(442367, 471089, 966109, 968879, 975899,100019, 100043, 100049,100057,100069,100019, 200009, 300017, 400051, 500041,123401, 202127, 966439, 155219, 248879)
...
setwd("c:\\Users\\iparra\\Downloads\\Data Science\\lab1\\") # Establezco el Working Directory
# cargo los datos
...
for ( vcp in c(-12,-10,-5,-3,-1,-0.5) )
{
  for (vmax_depth in c(4, 5 , 6, 7, 8, 9, 10)) {
    for (vmin_split in c(1000, 800, 600, 400, 300, 200, 100))
    {
      for( vmin_bucket in seq(vmin_split, vmin_split/2, by = -100) ) 
      {
